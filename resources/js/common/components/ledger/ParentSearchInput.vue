...
export default defineComponent({
    ...
    setup(props, { emit }) {
                ...
                state.products = [
                    {
                        ...
                        party_name: propVal.productData.product.name,
                    },
                ];
        ...
        const fetchProducts = debounce((value) => {
            ...
            if (value != "") {
                state.fetching = true;
                const filterString = `party_name lk "%${value}%"`;
                let url = `parent-ledger?fields=id,xid,party_name&filters=${encodeURIComponent(
                    filterString
                )}&limit=10`;
