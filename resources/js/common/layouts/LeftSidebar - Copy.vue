                ...
                >
                    ...
                    >
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.stock.sales.index')"
                            key="sales"
                        ...
                        >
                            {{ $t("menu.sales") }}
                                             ...
                                             <a-menu-item
                            @click="menuSelected(),handleSalesClick('admin.stock.sales-returns.index')"
                            key="sales_returns">
                            {{ $t("menu.sales_returns") }}
                        </a-menu-item>

                        <a-menu-item
                            @click="menuSelected(),handleSalesClick('admin.payments.in')"
                            key="payment_in"
                            v-if="
                                permsArray.includes('payment_in_view') ||
                                permsArray.includes('admin')
                        ...
                        <a-menu-item
                          @click="menuSelected(),handleSalesClick('admin.stock.quotations.index')"
                            key="quotations"
                            v-if="
                                (permsArray.includes('quotations_view') ||
                                    permsArray.includes('admin')) &&
                    ...
                    <a-sub-menu key="cash_and_bank">
                        ...
                        <a-menu-item
                             @click="menuSelected(),handleSalesClick('admin.cashbank.index')"
                            key="cashbank"
                        >
                            {{ "cashbank" }}
                        </a-menu-item>
                    ...
                    <a-sub-menu key="item_list">
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.productitem.index')"
                            key="ProductItem"
                        >
                            {{ "Product List" }}
                        </a-menu-item>
                    ...
                    <a-sub-menu key="master">
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.receipt.index')"
                            key="country"
                        >
                            {{ $t("menu.receipt") }}
                        </a-menu-item>
                        ...
                        <a-menu-item
                            @click="menuSelected(),handleSalesClick('admin.print.index')"
                            key="state"
                        >
                            {{ $t("menu.payment") }}
                        </a-menu-item>
                        ...
                        <a-menu-item
                           @click="menuSelected(),handleSalesClick('admin.station.index')"
                            key="station"
                        >
                            {{ $t("menu.contra") }}
                        </a-menu-item>
                    ...
                    <a-sub-menu
                        key="purchases"
                        v-if="
                            permsArray.includes('purchases_bill') ||
                    ...
                    >
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.stock.purchases.Billindex')"
                            key="bill"
                            v-if="
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.stock.purchases.Returnindex')"
                            key="return"
                            v-if="
                        ...
                        <a-menu-item
                             ...
                             @click="menuSelected(),handleSalesClick('admin.payments.out')"
                            key="payment_out"
                            v-if="
                                permsArray.includes('payment_out_view') ||
                                permsArray.includes('admin')
                    ...
                    <a-menu-item
                        ...
                        @click="menuSelected(),handleSalesClick('admin.stock.stock-transfers.index')"
                        key="stock_transfer"
                        v-if="
                    ...
                    <a-menu-item
                        ...
                        @click="menuSelected(),handleSalesClick('admin.pos.index')"
                        key="pos"
                    >
                    ...
                    <a-menu-item
                        ...
                        "
                         ...
                         @click="menuSelected(),handleSalesClick('admin.reports.cash_bank.index')"
                        key="cash_bank"
                    >
                        <BankOutlined />
                    ...
                    >
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.expense_categories.index')"
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.expenses.index')"
                            key="expenses"
                            v-if="
                                permsArray.includes('expenses_view') ||
                                permsArray.includes('admin')
                    ...
                    <a-menu-item
                        ...
                        "
                         ...
                         @click="menuSelected(),handleSalesClick('admin.users.index')"
                        key="users"
                    >
                        <UserOutlined />
                    ...
                    >
                        ...
                        <a-menu-item
                            v-if="
                                ...
                                permsArray.includes('admin')
                            "
                           @click="menuSelected(),handleSalesClick('admin.reports.payments.index')"
                            key="payments"
                        >
                            {{ $t("menu.payments") }}
                        </a-menu-item>
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.reports.stock.index')"
                            key="stock_alert"
                        >
                            {{ $t("menu.stock_alert") }}
                        </a-menu-item>
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.reports.sales_summary.index')"
                            key="sales_summary"
                        >
                        ...
                        <a-menu-item
                            ...
                            "
                             ...
                             @click="menuSelected(),handleSalesClick('admin.reports.stock_summary.index')"
                            key="stock_summary"
                        >
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.reports.rate_list.index')"
                            key="rate_list"
                        >
                            {{ $t("menu.rate_list") }}
                        </a-menu-item>
                        <a-menu-item
                            v-if="
                                ...
                                permsArray.includes('admin')
                            "
                            @click="menuSelected(),handleSalesClick('admin.reports.product_sales_summary.index')"
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.reports.users.index')"
                            key="users_reports"
                        >
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.reports.expenses.index')"
                            key="expense_reports"
                        >
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.reports.profit_loss.index')"
                            key="profit_loss"
                        >
                            {{ $t("menu.profit_loss") }}
                        </a-menu-item>
                    ...
                    <a-sub-menu key="hrm">
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.hrm.dashboards.index')"
                            key="dashboards"
                        >
                            {{ $t("menu.dashboard") }}
                        </a-menu-item>
                        <a-menu-item
                            ...
                            "
                            @click="menuSelected(),handleSalesClick('admin.hrm.staffs.index')"
                            key="staff"
                        >
                            <span>{{ $t("menu.staff_members") }}</span>
                        </a-menu-item>
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.hrm.all-holidays.index')"
                            key="holidays"
                        >
                            {{ $t("menu.holidays") }}
                        </a-menu-item>
                        <a-menu-item
                           @click="menuSelected(),handleSalesClick('admin.hrm.appreciations.index')"
                            key="appreciations"
                        >
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.hrm.leaves.index')"
                            key="leaves"
                        >
                            {{ $t("menu.leaves") }}
                        </a-menu-item>
                        <a-menu-item
                           @click="menuSelected(),handleSalesClick('admin.hrm.attendance.details')"
                            key="attendances"
                        >
                            {{ $t("menu.attendances") }}
                        </a-menu-item>
                        <a-menu-item
                            @click="menuSelected(),handleSalesClick('admin.hrm.payrolls.index')"
                            key="payrolls"
                        >
                            {{ $t("menu.payrolls") }}
                        </a-menu-item>
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.hrm_settings.index')"
                            key="hrm_settings"
                        >
                            {{ $t("menu.hrm_settings") }}
                        </a-menu-item>
                    ...
                    <a-sub-menu key="master_menu">
                        ...
                        <a-menu-item
                             ...
                             @click="menuSelected(),handleSalesClick('admin.country.index')"
                            key="country"
                        >
                            {{ "Country" }}
                        </a-menu-item>
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.state.index')"
                            key="state"
                        >
                            {{ "State" }}
                        </a-menu-item>
                        ...
                        <a-menu-item
                            @click="menuSelected(),handleSalesClick('admin.category.index')"
                            key="category"
                        >
                            {{ "Category" }}
                        </a-menu-item>
                        ...
                        <a-menu-item
                            @click="menuSelected(),handleSalesClick('admin.stock.customer.Customerindex')"
                            key="category"
                        >
                            {{ "Customer" }}
                        </a-menu-item>
                        ...
                        <a-menu-item
                            ...
                            @click="menuSelected(),handleSalesClick('admin.party.index')"
                            key="category"
                        >
                            {{ "Party" }}
                        </a-menu-item>
                    ...
                    <a-menu-item
                        ...
                        @click="menuSelected(),handleSalesClick('admin.settings.profile.index')"
                        key="settings"
                    >
                        <SettingOutlined />
                    ...
                    <a-menu-item
                        ...
                        @click="menuSelected(),handleSalesClick('admin.subscription.current_plan')"
                        key="subscription"
                    >
...
export default defineComponent({
    ...
    methods: {
    handleSalesClick(routeName) {
     
      if (this.$route.name === 'admin.stock.sales.create') {
