...
let selectedRowKeysValue = [];
        ...
        const setUrlData = (searchBy) => {
            ...
            datatableVariables.tableUrl.value = {
                url: `${props.orderType}?fields=id,xid,partyName{id,party_name,party_full_name},customer{id,cus_name},order_id,order_date,total_amount,invoice_path,invoice_number&searchBy=`+searchBy,
                filterString,
                filters: {
