    ...
    <a-row>
        <a-col :span="24">
            <div class="table-responsive"> 
                ...
                <a-table :columns="CaseBankColumns" :row-key="(record) => record.id" :data-source="table.data"
...
let selectedRowKeysValue = [];
        ...
        const setUrlData = (searchBy) => {
            ...
            datatableVariables.tableUrl.value = {
                url: `bill-returns?fields=id,xid,partyName{id,party_name},customer{id,cus_name},order_id,order_date,total_amount,invoice_path,invoice_number&searchBy=`+searchBy,
                filterString,
                filters: {
