  ...
  <a-row>
      <a-col :span="24">
          <div class="table-responsive"> 
              ...
              <a-table :columns="ExpenseColumns" :row-key="(record) => record.id" :data-source="table.data"
                  ...
                  <template #bodyCell="{ column, record }">
                      ...
                      <template v-if="column.dataIndex === 'party_full_name'">
                          <a-typography-link @click="viewItem(record)">
                              {{ record.party_name.party_full_name }}
                          </a-typography-link>
                      </template>
                      ...
                      <template v-if="column.dataIndex === 'action'">
                          <a-button   @click="editReturn(record.invoice_number)"
                      ...
                      <a-button   @click="printReturn(record.invoice_path)" style="margin-left: 4px">
                          <template #icon>
                              <span role="img" aria-label="printer" class="anticon anticon-printer"><svg focusable="false" data-icon="printer" width="1em" height="1em" fill="currentColor" aria-hidden="true" viewBox="64 64 896 896"><path d="M820 436h-40c-4.4 0-8 3.6-8 8v40c0 4.4 3.6 8 8 8h40c4.4 0 8-3.6 8-8v-40c0-4.4-3.6-8-8-8zm32-104H732V120c0-4.4-3.6-8-8-8H300c-4.4 0-8 3.6-8 8v212H172c-44.2 0-80 35.8-80 80v328c0 17.7 14.3 32 32 32h168v132c0 4.4 3.6 8 8 8h424c4.4 0 8-3.6 8-8V772h168c17.7 0 32-14.3 32-32V412c0-44.2-35.8-80-80-80zM360 180h304v152H360V180zm304 664H360V568h304v276zm200-140H732V500H292v204H160V412c0-6.6 5.4-12 12-12h680c6.6 0 12 5.4 12 12v292z"></path></svg><!----></span>
                          </template>
                      </a-button>
...
let selectedRowKeysValue = [];
      ...
      const setUrlData = (searchBy) => {
          ...
          datatableVariables.tableUrl.value = {
              url: `bill-returns?fields=id,xid,partyName{id,party_name,party_full_name},customer{id,cus_name},order_id,order_date,total_amount,invoice_path,invoice_number&searchBy=`+searchBy,
              filterString,
              filters: {
