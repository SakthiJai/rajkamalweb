                            ...
                            <a-typography-link>
                                {{
                                    record.opening_balance
                                        ? record.opening_balance.toFixed(2)
                                        : "0.00"
                                }}
                            </a-typography-link>
                        </template>
    ...
    methods: {
        ...
        handleKeyDown(event) {
            ...
            if (event.key === "F9") {
                ...
                setTimeout(function () {
                    if (that.selectedInvoice > 0) that.isEnterModal = true;
                }, 1000);
