                ...
                >
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-if="column.dataIndex === 'action'">
                            <a-button
                                @click="editReturn(record.cr_number)"
    ...
    setup(props, { emit }) {
        ...
        const setUrlData = (searchBy) => {
            ...
            datatableVariables.tableUrl.value = {
                url:
                    `${props.orderType}?fields=id,cr_number,xid,return_by,user{id,xid,user_type,name,email,address,tax_number,profile_image,profile_image_url,phone},partyName{id,party_name,party_full_name},customer{id,cus_name},cr_number,order_id,order_date,total_amount,invoice_path,items&searchBy=` +
                    searchBy,
                filterString,
                filters: {
            ...
            switch (event.keyCode) {
                ...
                default:
                    ...
                    if (this.returnList.length == 0) {
                        this.returnList = this.table.data;
                    }
                    setTimeout(function () {
                        const value =
