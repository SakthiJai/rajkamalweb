...
export default {
  ...
  this.recordId = id;
  try {
    /*const response = await axiosAdmin.get(`ledger/${id}`);
    this.formDataLedger =data; // Ensure this is initialized properly in your data
    console.log(response.data);*/

    // Navigate to the route with the record ID and form data
    this.$router.push({
