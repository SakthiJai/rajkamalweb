export default [
    ...
    },
    {
        ...
        children: [
            ...
            //ledgeritem
            {
                path: "/admin/ledgeritem",
                component: () => import("../views/itemlist/ledgeritem/index.vue"),
                name: "admin.stock.ledgeritem.index",
                meta: {
                    requireAuth: true,
                    menuParent: "ledgeritem",
                    menuKey: (route) => "ledgeritem",
                },
            },
