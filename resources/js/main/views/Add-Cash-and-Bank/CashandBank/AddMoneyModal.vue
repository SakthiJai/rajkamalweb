        ...
        <a-form layout="vertical">
                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    ...
                    >
                        <a-select
                            ...
                            v-model:value="formDataLedger.adjust_money"
                            style="width: 100%"
                        >
                            <a-select-option
                                key="Registered"
            ...
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="6" :lg="6">
                    <a-button type="primary" class="addmoney">
                        + Add Money
                    </a-button>
                </a-col>
                <a-col :xs="24" :sm="24" :md="6" :lg="6">
                    <a-button type="primary" class="reducemoney">
                        - Reduce Money
                    </a-button>
                </a-col>
            </a-row>
...
.addmoney {
    background-color: #2eeb28;
    border-color: rgb(29, 100, 180);
    color: black;
    border-radius: 50px;
}
.reducemoney {
