                    ...
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        ...
                        >
                            <input
                                ...
                                @input="
                                    formData.bill_number = $event.target.value
                                "
                ...
                <a-row :gutter="16">
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        <a-form-item
                            ...
                            :help="
                                rules.mobile_number
                                    ? rules.mobile_number.message
                                    : null
                            "
                            :validateStatus="
                                rules.mobile_number ? 'error' : null
                            "
                        >
                            <input
                    ...
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        <a-form-item
                            ...
                            :help="
                                rules.customer_name
                                    ? rules.customer_name.message
                                    : null
                            "
                            :validateStatus="
                                rules.customer_name ? 'error' : null
                            "
                        >
                            <a-input
                                readonly
...
export default {
    ...
    methods: {
        ...
        updateParent(selectedParty) {
            ...
            if (
                ...
                axiosAdmin.get(billNumberUrl).then((response) => {
                    ...
                    document.getElementById("form_item_bill_number").value =
                        this.formData.bill_number;
                    this.loading = false;
                });
            }
        ...
        updateCustomer(selectedParty) {
            ...
            document.getElementById("party_customer_id").value =
                this.formData.party_customer_id;
            document.getElementById("form_item_customer_name").value =
                this.formData.party_customer_name;
            document.getElementById("form_item_mobile_number").value =
                this.formData.party_customer_mobile;
        },
        updateProduct(selectedParty) {
            //console.log(selectedParty);
            this.formData.items[this.selectedItermIndex].item_id =
                selectedParty.id;
            ...
            this.formData.items[this.selectedItermIndex].max_single_unit_price =
                selectedParty.single_unit_price;
            this.formData.items[this.selectedItermIndex].quantity =
                selectedParty.quantity;
            this.formData.items[this.selectedItermIndex].maxquantity =
                selectedParty.quantity;
            this.formData.items[this.selectedItermIndex].packing =
                selectedParty.packing;
        ...
        getQuantity(index, event) {
            ...
            const quantity = document.getElementById(
                "item_product_quantity_" + index
            ).value;
            const price = document.getElementById(
                "item_product_price_" + index
            ).value;
            const discount = document.getElementById(
                "item_product_disc_" + index
            ).value;
            ...
            if (discount != "") {
                this.totalDiscountAmount = Number(
                    Number(this.totalDiscountAmount) -
                        Number(
                            document.getElementById(
                                "item_discount_total_" + index
                            ).value
                        )
                );
                document.getElementById("total_discount_text").innerHTML =
                    this.formatCurrency(Number(this.totalDiscountAmount));
                document.getElementById("discount_info_amount").innerHTML =
                    this.formatCurrency(Number(this.totalDiscountAmount));
                ...
                document.getElementById("grand_total").innerHTML =
                    this.formatCurrency(this.totalAmount);
            ...
            this.totalAmount = Number(
                Number(this.totalAmount) -
                    Number(
                        document.getElementById("item_product_amount_" + index)
                            .value
                    )
            );
            document.getElementById("grand_total").innerHTML =
            ...
            document.getElementById("sgst_total_text").innerHTML =
                this.formatCurrency(Number(this.totalIgstAmount));
            ...
            if (quantity == "") {
                ...
                document.getElementById("item_product_amount_" + index).value =
                    this.formatNumber(
                        Number(
                            Number(quantity) *
                                Number(this.revertFormattedNumber(price))
                        )
                    );
                this.totalAmount = Number(
                    Number(this.totalAmount) +
                ...
                this.totalAmount = Number(
                    Number(this.totalAmount) + Number(totalGstAmount) * 2
                );
                document.getElementById("grand_total").innerHTML =
                    this.formatCurrency(this.totalAmount);
                ...
                this.formData.tax_amount = Number(
                    Number(this.totalIgstAmount) * 2
                );
                this.formData.total = Number(this.totalAmount);
                this.formData.subtotal = Number(this.totalAmount);
                this.formData.due_amount = Number(this.totalAmount);
                ...
                if (discount != "") {
                    ...
                    this.totalAmount = Number(
                        Number(this.totalAmount) - Number(discountAmount)
                    );
                    document.getElementById("grand_total").innerHTML =
                        this.formatCurrency(this.totalAmount);
        ...
        getDiscount(index, event) {
            ...
            const singleProductAmount = document.getElementById(
                "item_product_amount_" + index
            ).value;
            const discount = document.getElementById(
                "item_product_disc_" + index
            ...
            this.totalDiscountAmount = Number(
                Number(this.totalDiscountAmount) -
                    Number(
                        document.getElementById("item_discount_total_" + index)
                            .value
                    )
            );
            document.getElementById("total_discount_text").innerHTML =
            ...
            if (discount == "") {
                ...
                let discountPercentage = discount / 100;
                let discountAmount =
                    Number(discountPercentage) * Number(singleProductAmount);
        ...
        checkDisc(index, event) {
            ...
            if (event.key == "Enter") {
                document
                    .getElementById(
                        "item_product_name_" + (this.selectedItermIndex + 1)
                    )
                    .focus();
                return false;
            }
