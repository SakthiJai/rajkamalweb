<template>
        ...
        <template #header>
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="3" :lg="3">
                    <h3 class="AddBankAccount">Cash and Bank</h3>
                </a-col>
              ...
              <a-button type="primary" @click="showAddBankModal" class="creating">
                    ...
                    <AddBankAccount v-if="isBankAccountModalVisible" :visible="isBankAccountModalVisible"
                        :formData="formData" :url="url" :addEditType="addEditType" :pageTitle="pageTitle"
                        :successMessage="successMessage" @addEditSuccess="handleSuccess" @closed="handlecashclose" />
        ...
        <a-row :gutter="16">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="24" :xl="24">
                <a-row :gutter="[16, 16]">
                    ...
                    <a-button type="primary" @click="showAddMoneyModal" class="creating">
                       Add Money
                    </a-button>
    ...
    <AddMoneyModal v-if="isMoneyModalVisible" :visible="isMoneyModalVisible"
    :formData="formData" :url="url" :addEditType="addEditType" :pageTitle="pageTitle"
    :successMessage="successMessage" @addEditSuccess="handleSuccess" @closed="handlemoneyclose" />
</template>
<script>
...
import showBankDetails from "../CashandBank/AddBankAccount.vue";
...
export default {
    ...
    methods: {
        ...
        handleKeydown(event) {
    if (event.key === 'F2') {
        this.isBankAccountModalVisible = !this.isBankAccountModalVisible;
    } else if (event.key === 'Escape' && this.isBankAccountModalVisible) {
        this.isBankAccountModalVisible = false;
    }
},

showAddMoneyModal(){
    this.isMoneyModalVisible=true;
},
handlemoneyclose(){
    this.isMoneyModalVisible=false;
},
        ...
        handleshowBankDetails() {
            console.log("BankDetails closed");
            this.isProuctsModalVisible = false;
            //this.focusProductList();
        },
        handleSuccess(xid) {
            // Handle success logic   isCashModalVisible
            this.isModalVisible = false;
