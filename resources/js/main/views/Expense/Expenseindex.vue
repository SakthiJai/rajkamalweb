<template>
        ...
        <template #header>
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="4" :lg="4">
                    <h3 class="gstinvoice">Expense List</h3>
                </a-col>
    ...
    <!-- expensecategory modal-->
    <ExpenseCategoryModal
    v-if="isExpenseCategoryVisible"
    :visible="isExpenseCategoryVisible"
    :formData="formData"
    :url="url"
    ...
    @closed="handleClose"
  />
     <!--- end expense category modal-->

    <admin-page-table-content>

            <ExpenseCategoryTable ref="BillReturnOrderTableRef" :orderType="orderType" :filters="filters" tableSize="middle" :bordered="true"
...
import ExpenseCategoryTable from "../../../main/components/order/ExpenseOrderTable.vue";
...
import ExpenseCategoryModal from "../../views/Expense-category/ExpenseCategoryModal.vue"
export default {
    components: {
        PlusOutlined,
        DeleteOutlined,
    ...
    data() {
        return {
            isExpenseCategoryVisible: false,
            formData: {},
            url: 'your-url-here',
            addEditType: 'add',
  ...
  beforeDestroy() {
    ...
    methods:
    {
        ...
        createNewBillEntry()
        {
        this.isExpenseCategoryVisible=true;
        },
      ...
      if (event.key === 'F2') {
        ...
        handleClose() {
            this.isExpenseCategoryVisible = false;
        },
        handleSuccess(xid) {
