<template>
        ...
        <template #header>
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="3" :lg="4">
                    <h3 class="gstinvoice">Journal Voucher List</h3>
                </a-col>
    ...
    <admin-page-table-content>
        <JournalTable ref="orderTableRef" :orderType="orderType" :filters="filters" tableSize="middle" :bordered="true"
...
import JournalTable from "../../../views/accounting-transfer/Journal/JournalTable.vue";
