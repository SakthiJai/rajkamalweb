    ...
    <a-card class="page-content-container mt-20 mb-20">
      <a-form layout="vertical">
        <a-row :gutter="16">
          <a-col :xs="24" :sm="24" :md="8" :lg="8">
            ...
            >
              ...
              <a-input
                ...
                id="party_id"
                :placeholder="$t('common.placeholder_default_text', [$t('stock.party_')])"
                @blur=""
              />
              <a-input
                hidden
          ...
          <a-col :xs="24" :sm="24" :md="8" :lg="8">
            <a-form-item
              :label="$t('stock.bill_number')"
              name="bill_number"
              :help="rules.bill_number ? rules.bill_number.message : null"
              :validateStatus="rules.bill_number ? 'error' : null"
              class="required"
            >
              <input
                ...
                :placeholder="
                  $t('common.placeholder_default_text', [$t('stock.bill_number')])
                "
              />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="24" :md="8" :lg="8">
            ...
            >
              ...
              <input
                ...
                ref="DateInput"
                required
                @keydown="handleKeydownDatePicker"
                @focus="changeColorOnFocus('order_date')"
                @blur="resetColorOnBlur('order_date')"
              />
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <SalesNumberModel
          ...
          :pageTitle="pageTitle"
          :successMessage="successMessage"
          @closed="handlenumberModel"
          @addEditSuccess="handleSuccess"
          v-on:mobile-method="handleSalesNumber"
          v-on:cutomer-method="updateCustomer"
        />
        <!-- sales modal number -->
        <a-row :gutter="16">
          <a-col :xs="24" :sm="24" :md="8" :lg="8">
            ...
            >
              <input
                id="form_item_mobile_number"
                v-model="formData.party_customer_mobile"
                placeholder="Press SpaceBar"
                @keydown.space.prevent="showNumberModal($event)"
                class="ant-input css-dev-only-do-not-override-wosfq4"
              />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="24" :md="8" :lg="8">
            <a-form-item
              :label="$t(`stock.customer_name`)"
              name="customer_name"
              :help="rules.customer_name ? rules.customer_name.message : null"
            ...
            >
              ...
              <a-input
                hidden
                v-model:value="formData.party_customer_id"
          ...
          <a-col :xs="24" :sm="24" :md="8" :lg="8">
            ...
            >
              <a-input
                ...
                :placeholder="
                  $t('common.placeholder_default_text', [$t('stock.address')])
                "
              />
            </a-form-item>
          </a-col>
                  ...
                  <tr v-for="(header, index) in formData.items" :key="index">
                    <td style="width: 30%">
                      ...
                      <a-input
                        ...
                        v-model="formData.items[index].item_id"
                      />
                    ...
                    <td style="width: 15%">
                      <input
                        ...
                        @focus="getQuantity(index, $event)"
                        @keydown="checkMaxQuantity(index, $event)"
                        name="quantity[]"
        ...
        <a-row :gutter="16">
          <a-col :xs="24" :sm="24" :md="12" :lg="12">
            <a-row :gutter="16">
              <a-col :xs="24" :sm="24" :md="12" :lg="12">
                <fieldset>
                  <legend class="basicdetalis">Discount Info</legend>
              ...
              <a-col :xs="24" :sm="24" :md="12" :lg="12">
                <fieldset>
                  <legend class="basicdetalis">Tax Info</legend>
                  <a-row :gutter="16" class="mt-10">
                    <a-col
                      :xs="12"
                      :sm="12"
              ...
              <a-col :xs="24" :sm="24" :md="24" :lg="24">
                <table class="responsive-table">
                  <thead>
                    <tr>
                      <th
                        v-for="(header, index) in addtionaldetalisheader"
                        :key="index"
                        class="tableheading"
                      >
                        {{ header }}
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        <a-input
                          disabled="true"
                          v-model="formData.igst_amount"
                          :id="`igst_amount_${index}`"
                          style="text-align: right; color: black; font-weight: bolder"
                          name="table_total_amount[]"
                        ></a-input>
                      </td>
                    </tr>
              ...
              <a-col :xs="24" :sm="24" :md="17" :lg="17">
                <a-row :gutter="16" class="mt-10">
                  ...
                  <a-col
                    ...
                    :md="12"
                    :lg="12"
                    style="text-align-last: right; font-size: 20px; font-weight: bolder"
                  >
        ...
        <a-row :gutter="16" class="mt-20 mb-20">
          ...
          <a-col :xs="24" :sm="24" :md="4" :lg="4">
            <a-button
              class="backgrounds"
              :loading="loading"
              @click="saveSalesEntry"
              block
            >
              <span class="shortcut">
                <code>F8 / End</code>
              </span>
              <span class="savebutton">{{ $t("common.save") }} <SaveOutlined /> </span>
            </a-button>
          </a-col>
          <a-col :xs="24" :sm="24" :md="1" :lg="1">
            <div class="dropdown">
              ...
              <ul v-if="isOpensave" class="dropdown-menus">
                <li
                  v-for="(item, index) in dropsitems"
                  :key="index"
          ...
          <a-col :xs="24" :sm="24" :md="3" :lg="3">
            <a-button class="draft" block> Save As Draft </a-button>
          </a-col>
          <a-col :xs="24" :sm="24" :md="3" :lg="3">
          ...
          <a-col :xs="24" :sm="24" :md="4" :lg="4">
            <a-button class="savecolse" block>
              ...
              <span class="savebutton">{{ $t("common.last_deal") }} </span>
            </a-button>
          </a-col>
        </a-row>
      </a-form>
        ...
        <a-col :xs="24" :sm="24" :md="24" :lg="24">
          ...
          >
            <a-input-number
              ...
              :placeholder="
                $t('common.placeholder_default_text', [$t('product.unit_price')])
              "
              min="0"
              style="width: 100%"
            >
        ...
        <a-col :xs="24" :sm="24" :md="24" :lg="24">
          ...
          >
            <a-input-number
              ...
              :placeholder="
                $t('common.placeholder_default_text', [$t('product.discount')])
              "
              min="0"
              style="width: 100%"
            >
  ...
  data() {
    return {
      ...
      dropsitems: [
        {
          text: "Save & SMS",
          icon: `<svg height="14" viewBox="0 0 1024 1024"><path fill="currentColor" d="M256 448h512v128h-512zM256 256h512v128h-512zM960 0h-896c-35.376 0-64 28.624-64 64v704c0 35.376 28.624 64 64 64h128v192l288-192h480c35.376 0 64-28.624 64-64v-704c0-35.376-28.624-64-64-64zM896 704h-416l-160 96v-96h-192v-576h768v576z"></path></svg>`,
          isSvg: true,
        },
        {
          text: "Save & Email",
          icon: `<svg height="14" viewBox="0 0 1024 1024"><path fill="currentColor" d="M959.998 128h-895.998c-35.342 0-64 28.624-64 64v640c0 35.376 28.658 64 64 64h895.998c35.344 0 64.002-28.624 64.002-64v-640c0-35.376-28.658-64-64.002-64zM832 256l-320 256-320-256h640zM896 768h-768v-448l384 320 384-320v448z"></path></svg>`,
          isSvg: true,
        },
        {
          text: "Save & Print",
  ...
  methods: {
    ...
    showNumberModal(event) {
      ...
      if (
        ...
        (this.formData.party_customer_mobile == undefined ||
          this.formData.party_customer_mobile == "" ||
          this.formData.party_customer_mobile.trim() == "")
      ) {
    ...
    handleCloseCustomer() {
      //console.log("Close 1",this.formData.customer_name);
      ...
      if (this.formData.bill_number == undefined || this.formData.bill_number == "") {
        ...
        axiosAdmin.get(billNumberUrl).then((response) => {
          ...
          document.getElementById(
            "form_item_bill_number"
          ).value = this.formData.bill_number;
          this.loading = false;
        });
      }
    },
    ...
    updateCustomer(selectedParty) {
      ...
      document.getElementById(
        "party_customer_id"
      ).value = this.formData.party_customer_id;
      document.getElementById(
        "form_item_customer_name"
      ).value = this.formData.party_customer_name;
      document.getElementById(
        "form_item_mobile_number"
      ).value = this.formData.party_customer_mobile;
    },
    updateProduct(selectedParty) {
      ...
      this.formData.items[this.selectedItermIndex].single_unit_price =
        selectedParty.single_unit_price;
      this.formData.items[this.selectedItermIndex].max_single_unit_price =
        selectedParty.single_unit_price;
      ...
      ).value = this.formData.items[this.selectedItermIndex].item_name;
      document.getElementById(
        "item_product_packing_" + this.selectedItermIndex
      ).value = this.formData.items[this.selectedItermIndex].packing;
      document.getElementById(
        "item_product_id_" + this.selectedItermIndex
      ).value = this.formData.items[this.selectedItermIndex].item_id;
      document.getElementById(
        "item_product_price_" + this.selectedItermIndex
      ).value = this.formatNumber(
        this.formData.items[this.selectedItermIndex].single_unit_price
      );

      document.getElementById(
        "item_product_quantity_" + this.selectedItermIndex
      ).value = this.formData.items[this.selectedItermIndex].quantity;
      document.getElementById(
        "item_product_amount_" + this.selectedItermIndex
      ).value = 0.0;
      document.getElementById("item_product_quantity_" + this.selectedItermIndex).focus();
    },
    ...
    showProductModal(event, index) {
      ...
      if (this.formData.party_name != "" && index > 0 && event.key == "Tab") {
        ...
        if (
          this.formData.bill_number == undefined ||
          this.formData.bill_number == "" ||
          this.formData.bill_number.trim() == ""
        ) {
    ...
    getQuantity(index, event) {
      ...
      if (discount != "") {
        this.totalDiscountAmount = Number(
          Number(this.totalDiscountAmount) -
            Number(document.getElementById("item_discount_total_" + index).value)
        );
        document.getElementById("total_discount_text").innerHTML = this.formatCurrency(
          Number(this.totalDiscountAmount)
        );
        document.getElementById("discount_info_amount").innerHTML = this.formatCurrency(
          Number(this.totalDiscountAmount)
        );
        ...
        document.getElementById("grand_total").innerHTML = this.formatCurrency(
          this.totalAmount
        );
      ...
      this.totalAmount = Number(
        Number(this.totalAmount) -
          Number(document.getElementById("item_product_amount_" + index).value)
      );
      document.getElementById("grand_total").innerHTML = this.formatCurrency(
        this.totalAmount
      );
      ...
      this.totalIgstAmount = Number(
        Number(this.totalIgstAmount) -
          Number(document.getElementById("igst_item_" + index).value)
      );
      ...
      this.totalAmount = Number(
        Number(this.totalAmount) -
          Number(document.getElementById("igst_item_" + index).value) * 2
      );
      document.getElementById("grand_total").innerHTML = this.formatCurrency(
        this.totalAmount
      );

      document.getElementById("sgst_total_text").innerHTML = this.formatCurrency(
        Number(this.totalIgstAmount)
      );
      document.getElementById("cgst_total_text").innerHTML = this.formatCurrency(
        Number(this.totalIgstAmount)
      );
      document.getElementById("igst_amount_0").value = this.formatCurrency(
        Number(this.totalIgstAmount)
      );
      document.getElementById("igst_amount_1").value = this.formatCurrency(
        Number(this.totalIgstAmount)
      );
      ...
      if (quantity == "") {
        ...
        document.getElementById("item_product_amount_" + index).value = this.formatNumber(
          Number(Number(quantity) * Number(this.revertFormattedNumber(price)))
        );
        this.totalAmount = Number(
          Number(this.totalAmount) +
            Number(document.getElementById("item_product_amount_" + index).value)
        ...
        this.totalIgstAmount = Number(
          Number(this.totalIgstAmount) + Number(totalGstAmount)
        );
        ...
        if (discount != "") {
          ...
          this.totalDiscountAmount = Number(
            Number(this.totalDiscountAmount) + Number(discountAmount)
          );

          document.getElementById("item_discount_total_" + index).value = Number(
            discountAmount
          );
          document.getElementById("total_discount_text").innerHTML = this.formatCurrency(
            Number(this.totalDiscountAmount)
    ...
    getDiscount(index, event) {
      ...
      const singleProductAmount = document.getElementById("item_product_amount_" + index)
        .value;
      const discount = document.getElementById("item_product_disc_" + index).value;
    ...
    checkSingleItemPrice(index, event) {
      ...
      if (
        ...
        notification.warning({
          placement: "bottomRight",
          message:
            "All sale rates should not be more than from M.R.P. and should not be less than from cost Per unit",
          //description: configObject.successMessage
        });
        ...
        notification.warning({
          placement: "bottomRight",
          message:
            "As Per M.R.P Allowed Upto : " +
            this.formData.items[index].max_single_unit_price,
          //description: configObject.successMessage
        });
        //const $toast = useToast();
