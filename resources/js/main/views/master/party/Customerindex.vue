        ...
        <AdminPageHeader>
            <template #breadcrumb>
                <a-breadcrumb separator="-" style="font-size: 12px">
                    ...
                    <a-breadcrumb-item
                        v-if="$route.path === '/admin/stock/party'"
                    >
                        {{ $t(`Party`) }}
                    </a-breadcrumb-item>
                    <a-breadcrumb-item
                        v-if="$route.path === '/admin/stock/customer/list'"
                    >
                        Customers
                    </a-breadcrumb-item>
                    <a-breadcrumb-item
                        v-if="$route.path === '/admin/stock/supplier/list'"
                    >
                        Suppliers
                    </a-breadcrumb-item>
                    <a-breadcrumb-item
...
import CustomerOrdertable from "../../../components/order/CustomerOrdertable.vue";
...
export default {
    ...
    mounted() {
        document
            .getElementById("walkcustomercreate")
