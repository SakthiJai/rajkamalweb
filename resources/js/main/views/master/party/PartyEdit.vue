<template>
          ...
          <form ref="myForm1" id="addledgerform" layout="vertical" @tt.prevent="">
            <a-row :gutter="16" class="mainfroms">
              <a-col :xs="24" :sm="24" :md="15" :lg="15" class="info">
                <fieldset class="fieldheightsss" style="margin-top: 12px">
                ...
                <a-row :gutter="16" v-for="(field, index) in formDataLedger.contactFields">
                  <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-row :gutter="16">
                      ...
                      <a-col :xs="24" :sm="24" :md="5" :lg="5">
                        <a-input
                          @keydown.enter="focusNextname(index)"
                          ref="FirstName"
                          ...
                          autocomplete="off"  class="contact-input"
                        />
                      </a-col>
                      ...
                      <a-col :xs="24" :sm="24" :md="5" :lg="5">
                        <a-input
                        @keydown.enter="focusNextlast(index)"
                      ...
                      <a-col :xs="24" :sm="24" :md="5" :lg="5">
                        <a-input
                          @keydown.enter="focusNextdesignation(index)"
                          v-model:value="
                      ...
                      <a-col :xs="24" :sm="24" :md="3" :lg="3">
                        <a-form-item
                          ...
                          :validateStatus="rules.customer_email ? 'error' : null"  class="required"
                        >
                        </a-form-item>
                      </a-col>
                      <a-col :xs="24" :sm="24" :md="5" :lg="5">
                        <span style="display: flex">
                          <a-input
                            type="Number"
                          @keydown.enter="focusNextnumber(index)"
                            v-model:value="
                              formDataLedger.contactFields[index].contact_number
                            "
                            autocomplete="off"   :id="'contact_number_' + index"
                          />
                        </span>
                        <span
                    ...
                    <a-row :gutter="16">
                      ...
                      <a-col :xs="24" :sm="24" :md="5" :lg="5">
                        <a-input
                          type="Number"
                          @keydown.enter="focusNextwhattsapp(index)"
                         :id="'contact_whatsapp_number_' + index"
                          v-model:value="
  ...
  try {
    ...
    focusNexts(index) {
      const nextInputId = 'contact_name_' + index;
    ...
    focusNextname(index)
    {
      const nextname = 'contact_last_name_' + index;
      const nextInputElement = document.getElementById(nextname);
      if (nextInputElement) {
        nextInputElement.focus();
      }
    },
    focusNextlast(index){
      const nextlastname = 'contact_designation_' + index;
      const nextInputElement = document.getElementById(nextlastname);
      if (nextInputElement) {
        nextInputElement.focus();
      }
    },

    focusNextdesignation(index){
      const nextnumber = 'contact_number_' + index;
      const nextInputElement = document.getElementById(nextnumber);
      if (nextInputElement) {
        nextInputElement.focus();
      }
    },
    focusNextnumber(index){
      const nextwatsapp = 'contact_whatsapp_number_' + index;
      const nextInputElement = document.getElementById(nextwatsapp);
      if (nextInputElement) {
        nextInputElement.focus();
      }
    },

    focusNextwhattsapp(index){
      const nextwatsapp = 'contact_email_id_' + index;
      const nextInputElement = document.getElementById(nextwatsapp);
      if (nextInputElement) {
        nextInputElement.focus();
      }
