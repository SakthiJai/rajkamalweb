                    ...
                    <a-row :gutter="16">
                      ...
                      <!-- <a-col :xs="24" :sm="24" :md="3" :lg="3">
                        <a-form-item
                          ...
                          name="party_type"
                          :help="
                            rules.party_type ? rules.party_type.message : null
                          "
                ...
                <a-row :gutter="16">
                  <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-row :gutter="16">
                      ...
                      <a-col :xs="24" :sm="24" :md="7" :lg="7">
                        <EditPartiescategorySearchInput
                          @valueChanged="
                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                  <a-row :gutter="16">
                    ...
                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                      ...
                      >
                      <a-select-option
                      key="GST Not Registered"
                      value="GST Not Registered"
                      aria-selected="true"
                    >
                    GST Not Registered
                    </a-select-option>
...
import EditPartiescategorySearchInput from "../../../../common/components/partyedit/EditPartiescategorySearchInput.vue";
  ...
  methods: {
    ...
    handleKeydown(event) {
      ...
      if (
        ...
        // this.saveLedgerEntry(); // Call saveLedgerEntry when F10 is pressed
...
focusNext1(event) {
     if(this.formDataLedger.ledger_type === 'GST Not Registered' || this.formDataLedger.ledger_type === 'Composition'){
      ...
      if (this.validateLedger()) {
        ...
        axiosAdmin
          ...
          .then((response) => {
            ...
            // Routing logic based on party_type
