...
import SupplierOrdertable from "../../../components/order/SupplierOrdertable.vue";
...
#suppliercreate .ant-table-thead > tr > th,
#suppliercreate .ant-table-tbody > tr > td {
