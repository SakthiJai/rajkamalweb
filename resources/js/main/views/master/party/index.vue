  ...
  <div id="partycreate">
    <AdminPageHeader class="sticky-header">
      <template #breadcrumb>
        <a-breadcrumb separator="-" style="font-size: 12px">
          ...
          <a-breadcrumb-item v-if="$route.path === '/admin/stock/party'">
            {{ $t(`Party`) }}
          </a-breadcrumb-item>
          <a-breadcrumb-item v-if="$route.path === '/admin/stock/customer/list'">
            Customers
          </a-breadcrumb-item>
          <a-breadcrumb-item v-if="$route.path === '/admin/stock/supplier/list'">
            Suppliers
          </a-breadcrumb-item>
          <a-breadcrumb-item v-if="$route.path === '/admin/stock/party'">
          ...
          <a-breadcrumb-item v-if="$route.path === '/admin/stock/supplier/list'">
            <span style="font-weight: bold"> Suppliers List</span>
          </a-breadcrumb-item>
        </a-breadcrumb>
        <a-button
          type="primary"
      ...
      <a-row :gutter="16">
        ...
        <a-col :xs="24" :sm="24" :md="12" :lg="24" :xl="24">
          <a-row :gutter="[16, 16]">
            ...
            <a-col :xs="24" :sm="24" :md="8" :lg="10" :xl="10" class="text-right">
              <ExprotTable
    ...
    <admin-page-table-content>
      <PartyOrdertable
        ...
        v-on:child-select-arrow="updateSelectArrowValue"
      />
    </admin-page-table-content>
  </div>
</template>
...
import LedgerModel from "../../stock-management/purchases/LedgerModel.vue";
import EnterprisesModel from "../../stock-management/purchases/EnterprisesModel.vue";
import OrderTable from "../../../components/order/OrderTable.vue";
import BillReturnOrderTable from "../../../components/order/BillReturnOrderTable.vue";
import PartyOrdertable from "../../../components/order/PartyOrdertable.vue";
...
#partycreate .ant-table-thead > tr > th,
#partycreate .ant-table-tbody > tr > td {
