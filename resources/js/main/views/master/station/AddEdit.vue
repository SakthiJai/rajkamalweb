        ...
        <a-form layout="vertical">
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-form-item
                        :label="$t('station.station_name')"
                        name="station_name"
                        :help="rules.station_name ? rules.station_name.message : null"
                        :validateStatus="rules.station_name ? 'error' : null"
                        class="required"
                    >
                        <a-input
                            v-model:value="formData.station_name"
                            :placeholder="
