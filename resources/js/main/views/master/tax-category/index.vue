        ...
        <template #header>
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="3" :lg="3">
                    <h3 class="CreateSaleMaster">Tax Category </h3>
                </a-col>
              ...
              <a-button type="primary" @click="showTaxModal" class="creating">
                    <PlusOutlined />
                    Create F2
                </a-button>
                    <CreateSaleMaster v-if="isTaxModalVisible" :visible="isTaxModalVisible"
                        :formData="formData" :url="url" :addEditType="addEditType" :pageTitle="pageTitle"
                        :successMessage="successMessage" @addEditSuccess="handleSuccess" @closed="handletaxclose" />
...
import TaxOrdertable from "../../../components/order/TaxOrdertable.vue";
//import showTaxDetails from "../tax-category/CreateSaleMaster.vue";
// import CreateSaleMaster from "../tax-category/CreateSaleMaster.vue";
...
import DateTimePicker from "../../../../common/components/common/calendar/DatePicker.vue";
 ...
 export default {
    ...
    methods: {
        ...
        handleKeydown(event) {
    if (event.key === 'F2') {
        this.isTaxModalVisible = !this.isTaxModalVisible;
    } else if (event.key === 'Escape' && this.isTaxModalVisible) {
        this.isTaxModalVisible = false;
    }
},
