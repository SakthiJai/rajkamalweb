<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`Discount Percentage`)" class="p-0" />
        </template>
        <template #breadcrumb>
    ...
    setup() {
        ...
        onMounted(() => {
            crudVariables.tableUrl.value = {
                url: "discounttype?fields=id,xid,discount_type,status",
            };
            ...
            crudVariables.langKey.value = "discount";
