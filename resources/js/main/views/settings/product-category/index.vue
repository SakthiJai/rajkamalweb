        ...
        <a-row :gutter="[16, 16]">
            <a-col :xs="24" :sm="24" :md="12" :lg="10" :xl="10">
                <a-space>
                    <template
                        v-if="
                            permsArray.includes('product_category.create') ||
                    ...
                    <!-- <a-button
                        v-if="
                            ...
                            (permsArray.includes('product_category.delete') ||
                                permsArray.includes('admin'))
                        "
                        type="primary"
...
onMounted(async () => {
    ...
    crudVariables.langKey.value = "product_category";
...
onBeforeUnmount(() => {
    ...
    if (isSearchFocused.value && !["ArrowUp", "ArrowDown", "Enter"].includes(event.key)) {
        return;
    }
