...
export default {
    ...
    mounted() {
        document
        .getElementById("billindex").addEventListener('keydown', this.handleKeydown);
    this.autoFocusInput();
  ...
  beforeDestroy() {
    ...
    document
        .getElementById("billindex").removeEventListener('keydown', this.handleKeydown);
  },
    methods:
    {
