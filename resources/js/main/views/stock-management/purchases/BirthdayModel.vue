                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="8" :lg="8">
                            <a-form-item :label="$t('stock.birthday_date')" name="stock.birthday_date"
                                :help="rules.birthday_date ? rules.birthday_date.message : null"
                                :validateStatus="rules.birthday_date ? 'error' : null">
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <DateTimePicker :dateTime="formData.birthday_date" @dateTimeChanged="(changedDateTime) =>
                    ...
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="8" :lg="8">
                            <a-form-item :label="$t('stock.anniversary_date')" name="stock.anniversary_date"
                                :help="rules.anniversary_date ? rules.anniversary_date.message : null"
                                :validateStatus="rules.anniversary_date ? 'error' : null">
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
