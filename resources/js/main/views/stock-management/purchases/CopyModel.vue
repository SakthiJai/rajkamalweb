                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="8" :lg="8">
                            <a-form-item :label="$t('stock.copy_from')" name="stock.copy_from"
                                :help="rules.copy_from ? rules.copy_from.message : null"
                                :validateStatus="rules.copy_from ? 'error' : null">
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-input v-model:value="formData.copy_from" placeholder="Search here.." />
                        </a-col>
                    </a-row>
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="8" :lg="8">
                            <a-form-item :label="$t('stock.copy_to')" name="stock.copy_to"
                                :help="rules.copy_to? rules.copy_to.message : null"
                                :validateStatus="rules.copy_to ? 'error' : null">
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-input v-model:value="formData.copy_to" placeholder="Wwwwwwwww" disabled />
                        </a-col>
                    </a-row>

                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="8" :lg="8">
                            <a-form-item :label="$t('stock.copy_sure')" name="stock.copy_sure"
                                :help="rules.copy_sure? rules.copy_sure.message : null"
                                :validateStatus="rules.copy_sure ? 'error' : null">
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-select v-model:value="formData.copy_sure" class="balance">
