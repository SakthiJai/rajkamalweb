                            ...
                            <table class="responsive-table">
                                ...
                                <tbody>
                                    <tr v-for="(header, index) in formData.items" :key="index">
                                        <td style="width:30%">
                                            <a-input v-model="formData.items[index].item_name" :ref="`input-${index}`"
                                                :id="`item_product_name_${index}`" name="party_name"
                                                @keydown="showProductModal(index)"></a-input>
                                        ...
                                        <td style="width:15%">
                                            <a-input :id="`item_product_packing_${index}`"
                                                v-model="formData.items[index].packing" name="party_name"
                                                readonly></a-input>
                                        </td>

                                        <td style="width:15%">
                                            <a-input :id="`item_product_quantity_${index}`"
                                                v-model="formData.items[index].quantity" @input="getQuantity(index)"
                                                name="quantity" @keypress="onlyForCurrency"></a-input>
                                        </td>

                                        <td style="width:15%">
                                            <a-input :id="`item_product_price_${index}`"
                                                v-model="formData.items[index].single_unit_price" readonly
                                                name="party_name"></a-input>
                                        </td>

                                        <td style="width:15%">
                                            <a-input :id="`item_product_disc_${index}`" @input="getDiscount(index)"
                                                v-model="formData.items[index].discount_rate"
                                                name="party_name"></a-input>
                                        </td>

                                        <td style="width:15%">
                                            <a-input readonly v-model="formData.items[index].amount"
                                                :id="`item_product_amount_${index}`"
                                                name="table_total_amount[]"></a-input>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                        <fieldset>
                            ...
                            <a-row :gutter="16" class="mt-10">
                                ...
                                <a-col :xs="12" :sm="12" :md="4" :lg="4">
                                    <span id="cgst_total_text">{{ (formData.tax_amount) }}</span>
                                </a-col>
                            </a-row>
                            <a-row :gutter="16" class="mt-10">
                                <a-col :xs="12" :sm="12" :md="12" :lg="12">
                                ...
                                <a-col :xs="12" :sm="12" :md="4" :lg="4">
                                    <span id="sgst_total_text">{{ (formData.tax_amount) }}</span>
                                </a-col>
                            </a-row>
                        </fieldset>
                    </a-col>
                ...
                <a-row :gutter="16">
                    ...
                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                        <table class="responsive-table">
                            <thead>
                                <tr>
                                    <th v-for="(header, index) in addtionaldetalisheader" :key="index"
                                        class="tableheading">
                                        {{ header }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(item, index) in additems" :key="index"
                                    ...
                                    <td>
                                        <a-input readonly v-model="formData.igst_amount" :id="`igst_amount_${index}`"
                                            name="table_total_amount[]"></a-input>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <a-row :gutter="16" class="mt-30">
                    ...
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        ...
                        <a-row :gutter="16" class="mt-10">
                            ...
                            <a-col :xs="12" :sm="12" :md="12" :lg="12">
                                <span id="grand_total">{{ grandTotal }}</span>
                            </a-col>
                        </a-row>
...
export default {
    ...
    methods: {
        ...
        updateProduct(selectedParty) {
            ...
            let item = this.formData.items[this.selectedItermIndex];

            item.item_id = selectedParty.id;
            item.item_name = selectedParty.name;
            item.single_unit_price = selectedParty.single_unit_price;
            item.quantity = selectedParty.quantity;
            item.maxquantity = selectedParty.quantity;

            document.getElementById("item_product_name_" + this.selectedItermIndex).value = item.item_name;
            document.getElementById("item_product_id_" + this.selectedItermIndex).value = item.item_id;
            document.getElementById("item_product_price_" + this.selectedItermIndex).value = item.single_unit_price;
            document.getElementById("item_product_quantity_" + this.selectedItermIndex).value = 0;
            document.getElementById("item_product_disc_" + this.selectedItermIndex).value = 0.00;
        },
        ...
        getQuantity(index) {
            ...
            document.getElementById("grand_total").innerHTML = this.totalAmount;

            if (quantity == "") {
                document.getElementById("item_product_amount_" + index).value = "";
            }
            else {
                document.getElementById("item_product_amount_" + index).value = Number(Number(quantity) * Number(price));
                this.totalAmount = Number(Number(this.totalAmount) + Number(document.getElementById("item_product_amount_" + index).value));
                document.getElementById("grand_total").innerHTML = this.totalAmount;
            }
            ...
            document.getElementById("sgst_total_text").innerHTML = totalGstAmount;
            document.getElementById("cgst_total_text").innerHTML = totalGstAmount;
            document.getElementById("igst_amount_0").value = totalGstAmount;
            document.getElementById("igst_amount_1").value = totalGstAmount;
