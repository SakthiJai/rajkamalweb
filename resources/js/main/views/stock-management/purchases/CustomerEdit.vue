...
<!--
        ...
        <a-col :xs="24" :sm="24" :md="11" :lg="11" class="info">
          <fieldset class="fieldheightsss">
            ...
            <!--  phone  number and whast app hnumber -->
                ...
                <a-row :gutter="16">
                  ...
                  <a-col :xs="24" :sm="24" :md="5" :lg="5">
                    <a-form-item
                      ...
                      :help="rules.cus_phone_number ? rules.cus_phone_number.message : null"
                      :validateStatus="rules.cus_phone_number ? 'error' : null"
                    >
                    </a-form-item>
                  </a-col>
...
export default defineComponent({
  ...
  created() {
    ...
    this.getMobileData(this.editId);
  },
  components: {
    PlusOutlined,
    LoadingOutlined,
  ...
  methods: {
    async getMobileData(id) {


      try {
        if (id > 0) {
          const response = await axiosAdmin.get(`getcustomer/${id}`);
          this.formDataLedger.cus_name = response.data.cus_name;
          this.formDataLedger.mobile_number = response.data.mobile_number;
          this.formDataLedger.age = response.data.age;
          this.formDataLedger.address = response.data.address;
          this.formDataLedger.dob = response.data.dob;
          this.formDataLedger.email = response.data.email;
          this.formDataLedger.government_id = response.data.government_id;
          this.formDataLedger.phone_number = response.data.phone_number;
          this.formDataLedger.pin_number = response.data.pin_number;
          this.formDataLedger.whatsapp_numbner = response.data.whatsapp_numbner;
          this.formDataLedger.customer_city = response.data.customer_city;

          this.formDataLedger.billing_discount = response.data.billing_discount;
          this.formDataLedger.customer_type = response.data.customer_type;
          this.formDataLedger.gender = response.data.gender;
