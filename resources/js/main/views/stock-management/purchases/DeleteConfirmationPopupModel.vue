            ...
            <div class="page-wrapper">
                <div class="custom-modal">
                    ...
                    <div class="content">
                        ...
                        <p class="message-type closemessage">
                            Are you sure want to delete?
                        </p>

                        <!-- Yes button to close the popup    confirmDeletion   @click="handlePopupClose()"-->
                        <button
                            class="yesbutton"
                            type="button"
                            @click="confirmDeletion()"
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const confirmDeletion = (index) => {
            emit("confirmDeletion", index); // Emit the index to the parent
