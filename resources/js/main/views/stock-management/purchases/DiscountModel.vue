                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-row :gutter="16">
                        ...
                        <a-col :xs="24" :sm="24" :md="8" :lg="8">
                            <a-form-item :label="$t('stock.item_discount')" name="stock.item_discount"
                                :help="rules.item_discount ? rules.item_discount.message : null"
                                :validateStatus="rules.item_discount ? 'error' : null">
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-input v-model:value="formData.item_discount" ref="itemInput"
                    ...
                    <a-row :gutter="16">
                        ...
                        <a-col :xs="24" :sm="24" :md="8" :lg="8">
                            <a-form-item :label="$t('stock.exp_discount')" name="stock.exp_discount"
                                :help="rules.exp_discount ? rules.exp_discount.message : null"
                                :validateStatus="rules.exp_discount ? 'error' : null">
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="5" :lg="5">
                            <a-select v-model:value="formData.sale" class="balance">
                        ...
                        <a-col :xs="24" :sm="24" :md="7" :lg="7">
                            <a-input v-model:value="formData.exp_discount"
                                :style="{ backgroundColor: accountGroupColor }"
                                @focus="changeColorOnFocus('accountGroup')" @blur="resetColorOnBlur('accountGroup')" />
                        </a-col>
                    </a-row>
...
export default defineComponent({
    ...
    methods: {
        ...
        autoFocusInput() {
            this.$nextTick(() => {
                this.$refs.itemInput.focus();  // Automatically focus the input
            });
        },
        handleClose() {
