    ...
    <AdminPageHeader>
        <template #header>
           ...
           <!-- payments modal-->
            ...
            @closedbyclose ="handleClosePrintByClose"
        />
        ...
        <template #breadcrumb>
            <a-breadcrumb separator="-" style="font-size: 12px;width:75%" >
                <a-breadcrumb-item>
      ...
      @keydown="handlePartyNameKeydown" -->
        ...
        <a-card class="page-content-container mt-5 mb-5">
            ...
            <a-col :xs="24" :sm="24" :md="8" :lg="8">
                    ...
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        <a-form-item :label="$t('Quotation Number')" name="quotation_number"
                            :help="rules.quotation_number ? rules.quotation_number.message : null"
                            :validateStatus="rules.quotation_number ? 'error' : null" class="required">

                            <input v-model="formData.quotation_number" id="form_item_quotation_number" readonly tabindex="-1" @keydown="validateMobile($event,index)"
                                @input="formData.quotation_number = $event.target.value"  class="ant-input css-dev-only-do-not-override-wosfq4"
                    ...
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                      <!---->  <a-form-item :label="$t('stock.order_date')" name="order_date"
                            ...
                            :validateStatus="rules.order_date ? 'error' : null">
                                ...
                                <input type="date" v-model="formData.order_date" class="ant-input css-dev-only-do-not-override-wosfq4" id="order_date" ref="DateInput" required @keydown="handleKeydownDatePicker($event)"
                ...
                <a-row :gutter="16">
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        ...
                        <a-form-item :label="$t(`stock.mobile_number`)" name="mobile_number" :help="rules.mobile_number ? rules.mobile_number.message : null
                            ...
                            <input autocomplete="off" id="form_item_mobile_number"   v-model="formData.party_customer_mobile" placeholder="Press SpaceBar"
                                @keydown="showNumberModal($event)" class="ant-input css-dev-only-do-not-override-wosfq4 mobilenumbering"   />
                        </a-form-item>
                    </a-col>
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                    ...
                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        <a-form-item :label="$t(`stock.address`)" name="address" :help="rules.address ? rules.address.message : null
                            ...
                            <input autocomplete="off" id="form_item_address" class="ant-input css-dev-only-do-not-override-wosfq4" v-model="formData.address" @keydown="addressEvent($event)"  :placeholder="$t('common.placeholder_default_text', [
                                $t('stock.address'),
                            ])
                                " />
                        </a-form-item>
...
//import PrintModel from "./PrintModel.vue";
 import QuotationPrintModel from "./QuotationPrintModel.vue";
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const { salesItemColumns } = fields();
          formData=({
                ...
                items:[
                    {index:1,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:2,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:3,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:4,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:5,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:6,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:7,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:8,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:9,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                    {index:10,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null,cgst:null,sgst:null,unique:Math.random().toString(36).substring(2,7)},
                ],

                invoiceitems:[
                    {index:1,item_id:null,item_name:null,unit_id:null,quantity:'',mrp:null,single_unit_price:null,discount_type_id:null,discount_value:0,discount_rate:null,amount:null,maxquantity:0,max_single_unit_price:0,packing:null},
                ],
    ...
    data() {
        ...
        isSvg: true  }
            ...
            headers: ['Product', 'Packing', 'Qty', 'Rate','Tax %','Disc Type', 'Disc Value', '₹ Amount'],
    ...
    mounted() {
       ...
       // document.getElementById('salescreatevue').addEventListener('keydown', this.handleKeyDowning);
        this.autoFocusInput();
        const quotationNumberUrl = `sales/quotationNumber`;
                axiosAdmin.get(quotationNumberUrl).then((response) => {
                    console.log(response)
                    if (this.selectedInvoice == null || this.selectedInvoice == "" || this.selectedInvoice == undefined || this.selectedInvoice == "null") {
                        this.formData.quotation_number = response.data.ref;
                        this.formData.invoice_number = response.data.ref;
                    }
                    // this.formData.quotation_number = response.data.ref;
                    // console.log(this.formData.quotation_number)
                this.discountTypes = response.data.discountItems;
                document.getElementById("form_item_quotation_number").value = this.formData.quotation_number;
                //this.loading= false;
                 });
...
deleteItem()
{
    ...
    if (this.selectedItermIndex!=null || this.selectedItermIndex!=undefined) {
      ...
      getInvoiceDetails(){
        ...
        {
            this.formData.quotation_number=this.selectedInvoice;
            this.spinning = true;
            axiosAdmin
            ...
            .then(response => {  console.log(response)
                ...
                if(response.data.invoiceItems && response.data.invoiceItems.length>0)
                {
                   ...
                   // totalcgst = this.getTotalAmount("cgst");
                    ...
                    this.formData.total = (grand_total - total_disc) + (totalsgst > 0 ? ((totalsgst / 2) / 100) * grand_total : 0);
                    ...
                    document.getElementById("igst_amount_2").value = this.formatCurrency(total1 + total2);
...
if(input==27)
        ...
        setTimeout(function(){document.getElementById('btn-Ledger').focus();},100);
        ...
        updateParent(selectedParty) {
           ...
           // console.log("hello child" + this.formData.name)
            ...
            {
               /* this.loading= true;
                const quotationNumberUrl = `quotations/quotationNumber`+"/"+this.formData.party_id;
                axiosAdmin.get(quotationNumberUrl).then((response) => {
                //console.log(response)
                this.formData.quotation_number = response.data.ref;
                    this.discountTypes = response.data.discountItems;
        ...
        updateProduct(selectedParty) {
            console.log('Cgst Tax',selectedParty.lgst);
            this.formData.items[this.selectedItermIndex].item_id= selectedParty.id
                 ...
                 document.getElementById("item_product_quantity_"+this.selectedItermIndex).value = this.formData.items[this.selectedItermIndex].quantity;this.recentEventId
           ...
           this.recentEventId = event;
            ...
            console.log('=>', index, event.key, event.keyCode, this.formData.items[index].item_id)
                ...
                {console.log("AAH");
                    ...
                    this.selectedItermIndex =  index;
                    if(this.formData.quotation_number==undefined || this.formData.quotation_number=="" || this.formData.quotation_number.trim()==""){ ////console.log('+>',this.formData.bill_number)
                        document.getElementById("form_item_quotation_number").focus();
                        event.preventDefault();
                        return false;
                    }
        ...
        getTotalAmount(type)
        {
            ...
            this.formData.items.forEach((element)=>{
                ...
                if (element.item_id > 0 && element.discount_rate >= 0) {
                    if (element.discount_type_id == 2) {
                        const baseTotal = Number(element.single_unit_price) * Number(element.quantity);
                    ...
                    if (element.discount_type_id == 4) {
                        const baseTotal = Number(element.discount_rate) * Number(element.quantity);
            ...
            if(type=="sgst"){return (sgst/100)*total;}
            else if(type=="cgst") {return (cgst/100)*total; }
        ...
        checkDisc(index, event) {
            if (event.shiftKey && (event.key === "Tab" || event.key === "Enter") && (Number(event.target.value) <= 0)) {
                     return;
                }
        ...
        success(response)
        {
            this.formData.quotation_number = this.formData.quotation_number;
            this.formData.selectedInvoice = this.formData.quotation_number;
        ...
        successDraft(response)
        {
            ...
            notification.success({
                        placement:  "bottomRight",
                        message: "Draft Quatation saved successfully !    ",
                        description: response.message
                    });
            //this.isPaymentsModalVisible= true;
            this.isPrintModalVisible=true;
        ...
        validateSales()
        {
            ...
            else if (this.formData.party_customer_mobile == undefined || this.formData.party_customer_mobile == "" || this.formData.party_customer_mobile.trim() == "") {
                console.log('+>', this.formData.quotation_number)
        ...
        saveSalesEntry(event)
        {
            ...
            this.spinning= true;
            axiosAdmin
            .post("sales/quotationCreate", this.formData)
            .then(response => {  console.log(response)
                // Toastr Notificaiton
                this.spinning= false;
        ...
        event.preventDefault();
            ...
            if((event.keyCode==13 ||  event.keyCode==9) && Number(this.formData.items[index].quantity)>0)
            {
        ...
        //     content: 'Transaction data will be loss, Are you sure you want to closerrr?',
      ...
      setTimeout(() => {
        ...
        updateDiscount(index,event)
        {
            ...
            console.log(this.selectedItermIndex,this.formData.items[this.selectedItermIndex].discount_type_id);
