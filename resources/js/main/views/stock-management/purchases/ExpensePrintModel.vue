...
export default defineComponent({
    ...
    methods: {
        ...
        printpdf() {
            ...
            this.loading = true;
            axiosAdmin
                .post("expenses/getExpensePdf", {
                    invoice: document.getElementById("form_item_bill_number")
                        .value,
                })
                .then((response) => {
                    this.$emit("closed");
