                                ...
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        ...
                                        <span style="display: flex">
                                            <StationSearchInput @valueChanged="(productId) => (formData.product_id = productId)
                            ...
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        ...
                                        <span style="display: flex">
                                            <CountySearchInput @valueChanged="(productId) => (formData.product_id = productId)
                                                " @valueSuccess="getStockValue" :productData="data"
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        ...
                                        <StateSearchInput @valueChanged="(productId) => (formData.state_id = productId)
                                            " @valueSuccess="getStockValue" :productData="data"
                            ...
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="19" :lg="19">
                                        ...
                                        <ParentSearchInput @valueChanged="(productId) => (formData.product_id = productId)
                                            " @valueSuccess="getStockValue" :productData="data"
                                                ...
                                                <span style="display: flex">
                                                    <a-input-group compact>
                                                        ...
                                                        <a-input v-model:value="formDataLedger.whatsapp_number" c
                                                            style="width:70%" type="number" maxlength="10" />
                                                    </a-input-group>
                    ...
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            <a-row :gutter="16">
                                ...
                                <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                    <a-input v-model:value="formDataLedger.pan_number" type="number" />
                                </a-col>
                            </a-row>
                                ...
                                <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                    <span style="display: flex">
                                        <a-input-group compact>
                                            ...
                                            <a-input v-model:value="formDataLedger.whatsapp_number" class="amount" />
                                        </a-input-group>
                                        <a-button type="primary" class="buttonstype">
                                            <PlusOutlined />
                                        </a-button>
                                    </span>
                                </a-col>
