<template>
    <a-modal :open="visible" :width="drawerWidth" :closable="false" :centered="true" @close="handleClose"
        ...
        <form ref="myForm1" id="myForm1" layout="vertical" @submit.prevent="onSubmitLedger">
            <a-row :gutter="16">
                            ...
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <a-input name="party_name" id="ledgerName" v-model:value="formDataLedger.party_name"
            ...
            <a-row :gutter="16">
                ...
                <a-col :xs="24" :sm="24" :md="9" :lg="9">
                    <button @click="onSubmit" type="button" id="btn-Ledger" title="Ledger"
