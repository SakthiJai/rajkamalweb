                    ...
                    <a-row :gutter="16">
                      ...
                      <a-col :xs="24" :sm="24" :md="12" :lg="12">
                        <TaxCategorySearchInput
                          ...
                          @input="validateField('tax_category')"
                          @keyup.enter="focusNext"
                        />
                      </a-col>
                    </a-row>
                    ...
                    <a-row :gutter="16">
                      <a-col :xs="24" :sm="24" :md="8" :lg="8">
                        <a-form-item
                          ...
                          name="as_on_date"
                          :help="rules.as_on_date ? rules.as_on_date.message : null"
                          :validateStatus="rules.as_on_date ? 'error' : null"
                        >
                        </a-form-item>
                      </a-col>
                      <a-col :xs="24" :sm="24" :md="12" :lg="12">
                ...
                <a-row :gutter="16">
                  ...
                  <a-col :xs="24" :sm="24" :md="14" :lg="14">
                    <a-input
                      ...
                      @input="clearValidationError('brand_name')"
                      value=""
                      @keyup.enter="focusNext"
                    >
                    </a-input>
  ...
  methods: {
    ...
    validateInput() {
      ...
      const fieldsToValidate = [
        ...
        { key: "tax_category", label: "This Field is required." },
    ...
    // handleGodownSelection(productId) {
    //     // Update the god_owns value
    //     this.formDataLedger.god_owns = productId;

    //     // Move focus to the opening_stock input field
    //     this.$nextTick(() => {
    //         const openingStockInput = this.$refs.openingStockInput;
    //         if (openingStockInput && openingStockInput.focus) {
    //             openingStockInput.focus();
    //         } else {
    //             console.error("Opening stock input field not found.");
    //         }
    //     });
    // },
    ...
    //     //         message: "Opening_stock is required.",
    //     //     };
    //     //     isValid = false;
    //     // } else {
    ...
    //     // if (
    //     //     !this.formDataLedger.low_stock ||
    //     //     this.formDataLedger.low_stock.trim() === ""
    //     // ) {
    //     //     this.rules.low_stock = {
    //     //         message: "Low_stock is required.",
    //     //     };
    //     //     isValid = false;
    //     // } else {
