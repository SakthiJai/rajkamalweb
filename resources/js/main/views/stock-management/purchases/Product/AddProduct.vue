                    ...
                    <fieldset class="fieldheightsss">
                            ...
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.add_product_name')
                                    ...
                                    <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        <a-input name="name" v-model:value="formDataLedger.name" value="">
                                        </a-input>
                                    </a-col>
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.packing')" name="packing" :help="rules.packing
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.M_R_P ')" name="mrp" :help="rules.M_R_P
                                                ? rules.M_R_P.message
                                                : null
                                            " :validateStatus="rules.M_R_P ? 'error' : null
                                                ">
                                        </a-form-item>
                                    </a-col>
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Unit_1st')" name="unit_1st" :help="rules.unit_1st
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <a-input name="unit_1st" v-model:value="formDataLedger.unit_1st
                                            " value="" placeholder="PCS" />
                                    </a-col>

                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Purchase_Rate')" name="purchase_rate" :help="rules.Purchase_Rates
                                                ? rules.Purchase_Rate
                                                    .message
                                                : null
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Unit_in_Decimal')" name="unit_in_decimal" :help="rules.unit_in_decimal
                                                ? rules.unit_in_decimal
                                                    .message
                                                : null
                                            " :validateStatus="rules.unit_in_decimal
                                                    ? 'error'
                                                    : null
                                                ">
                                        </a-form-item>
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Cost')" name="cost" :help="rules.Cost
                                                ? rules.Cost.message
                                                : null
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.HSN_SAC')" name="hsn_sac
" :help="rules.hsn_sac
    ...
    " :validateStatus="rules.hsn_sac ? 'error' : null
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Sale_Rate')" name="sale_rate" :help="rules.sale_rate
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Tax_Category')" name="tax_category" :help="rules.tax_category
                                                ? rules.tax_category.message
                                                : null
                                            " :validateStatus="rules.tax_category
                                                    ? 'error'
                                                    : null
                                                " class="required">
                                        </a-form-item>
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <UnitSearchInput name="tax_category" v-model:value="formDataLedger.tax_category
                                            " class="required" placeholder="Select Tax Category" />
                                    </a-col>

                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Rate_B')" name="rate_b" :help="rules.Rate_B
                                                ? rules.Rate_B.message
                                                : null
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Company')" name="company" :help="rules.company
                                                ? rules.company.message
                                                : null
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <UnitSearchInput name="company" v-model:value="formDataLedger.company
                                            " placeholder="--Blank--" />
                                    </a-col>

                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Free_Scheme')" value="" :help="rules.Free_Scheme
                                                ? rules.Free_Scheme.message
                                                : null
                                            " :validateStatus="rules.Free_Scheme
                                                    ? 'error'
                                                    : null
                                                ">
                                        </a-form-item>
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Scheme_Type')" name="scheme_type" :help="rules.Scheme_Type
                                                ? rules.Scheme_Type.message
                                                : null
                                            " :validateStatus="rules.Scheme_Type
                                                    ? 'error'
                                                    : null
                                                "></a-form-item>
                                    </a-col>
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <a-select v-model:value="formDataLedger.scheme_type
                                            ...
                                            <a-select-option key="Half Scheme" value="Half Scheme" aria-selected="true">
                                                Half Scheme
                                            </a-select-option>
                                            <a-select-option key="1/3 Scheme" value="1/3 Scheme" aria-selected="true">
                                                1/3 Scheme
                                            </a-select-option>
                                            <a-select-option key="Qtr. Scheme" value="Qtr. Scheme" aria-selected="true">
                                                Qtr. Scheme
                                            </a-select-option>
                                            <a-select-option key="All Scheme" value="All Scheme" aria-selected="true">
                                                All Scheme
                                            </a-select-option>
                                            <a-select-option key="Whole Scheme" value="Whole Scheme"
                                                aria-selected="true">
                                                Whole Scheme
                                            </a-select-option>
                                            <a-select-option key="No Scheme" value="No Scheme" aria-selected="true">
                                                No Scheme
                                            </a-select-option>
                                        </a-select>
                                    </a-col>
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Status')" name="status" :help="rules.Status
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <a-select v-model:value="formDataLedger.status
                                            ...
                                            <a-select-option key="Discontinue" value="Discontinue" aria-selected="true">
                                                Discontinue
                                            </a-select-option>
                                        </a-select>
                                    </a-col>
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Color_Type')" name="color_type" :help="rules.Color_Type
                                                ? rules.Color_Type.message
                                                : null
                                            " :validateStatus="rules.Color_Type
                                                    ? 'error'
                                                    : null
                                                ">
                                        </a-form-item>
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <a-select v-model:value="formDataLedger.color_type
                                            ...
                                            <a-select-option key="RED" value="RED" aria-selected="true"
                                                style="background-color: red">
                                                RED
                                            </a-select-option>
                                            <a-select-option key="Yellow" value="Yellow" aria-selected="true"
                                                style="background-color: yellow">
                                                Yellow
                                            </a-select-option>
                                            <a-select-option key="Blue" value="Blue" aria-selected="true"
                                                style="background-color: blue">
                                                Blue
                                            </a-select-option>
                                            <a-select-option key="Green" value="Green" aria-selected="true"
                                    ...
                                    <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Rate_D')" name="rate_d" :help="rules.ledger_type
                                                        ? rules.ledger_type
                                                            .message
                                                        : null
                                                    " :validateStatus="rules.ledger_type
                                                            ? 'error'
                                                            : null
                                                        ">
                                                </a-form-item>
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Rate_F')" name="rate_f" :help="rules.pan_number
                                                        ? rules.pan_number
                                                            .message
                                                        : null
                                                    " :validateStatus="rules.pan_number
                                                            ? 'error'
                                                            : null
                                                        ">
                                                </a-form-item>
                            ...
                            <a-tab-pane key="contactinfo" tab="Discount">
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Discount')
                                                    " name="discount" :help="rules.ledger_type
                                                            ? rules.ledger_type
                                                                .message
                                                            : null
                                                        " :validateStatus="rules.ledger_type
                                            ...
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                                <a-select v-model:value="formDataLedger.discount
                                                    ...
                                                    <a-select-option key="No Services" value="No Services"
                                                        aria-selected="true">
                                                        No Services
                                                    </a-select-option>
                                                </a-select>
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Item_Disc_1 ')
                                                    " name="item_disc">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Volume_Dis_1')
                                                    ">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Max_Disc')
                                                    " name="max_disc">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                            ...
                            <a-tab-pane key="bankdetails" tab="Quantity">
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Min_Quantity')
                                                    " name="min_quantity">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Max_Quantity')
                                                    " name="max_quantity">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.ReorderDays')
                                                    " name="reorder_days">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.ReordeQty')
                                                    " name="reorder_qty">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                            ...
                            <a-tab-pane key="visibility" tab="Others Info">
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Prohibited')
                                                    " name="prohibited" :help="rules.pan_number
                                                            ? rules.pan_number
                                                                .message
                                                            : null
                                                        " :validateStatus="rules.pan_number
                                            ...
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                                <a-select v-model:value="formDataLedger.prohibited
                                                    " style="width: 100%">
                                                    <a-select-option key="Registered" value="Registered"
                                                        aria-selected="true">
                                                        No
                                                    </a-select-option>
                                                    <a-select-option key="Composition" value="Composition"
                                                        aria-selected="true">
                                                        Yes
                                                    </a-select-option>
                                                </a-select>
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Visibility')
                                                    " name="visibility">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.MFR_Name')
                                                    " name="mfr_name">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                        ...
                                        <a-row :gutter="16">
                                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                                                <a-form-item :label="$t('stock.Upload_Image')
                                                    " name="image">
                                                </a-form-item>
                                            </a-col>
                                            <a-col :xs="24" :sm="24" :md="14" :lg="14">
                ...
                <a-col :xs="24" :sm="24" :md="9" :lg="9">
                    ...
                    <button type="button" id="btn-Ledger" title="Ledger" class="btn default-btn ng-star-inserted">
                        <span class="box"><span class="shortcut ng-star-inserted"><code>Esc</code></span><span
                                class="ng-star-inserted">Close</span></span><span class="effect"></span>
                    </button>
                </a-col>
            </a-row>
