                ...
                <a-row :gutter="16">
                  ...
                  <a-col :xs="24" :sm="24" :md="5" :lg="5">
                    <a-form-item
                      :label="$t('M_R_P ')"
                      name="mrp"
                      :help="rules.M_R_P ? rules.M_R_P.message : null"
                  ...
                  <a-col :xs="24" :sm="24" :md="7" :lg="7">
                    <a-input-group compact>
                      <a-button type="primary" class="productnumber"> INR </a-button>
                      <a-input
              ...
              <a-col :xs="24" :sm="24" :md="24" :lg="24">
                <a-row :gutter="16">
                  ...
                  <a-col :xs="24" :sm="24" :md="7" :lg="7">
                    <UnitSearchInput
                      name="unit_1st"
                      @valueChanged="(productId) => (formDataLedger.unit_1st = productId)"
            ...
            <a-row :gutter="16">
              <a-col :xs="24" :sm="24" :md="24" :lg="24">
                <a-row :gutter="16">
                  ...
                  <a-col :xs="24" :sm="24" :md="7" :lg="7">
                    <a-select
                      v-model="formDataLedger.unit_in_decimal"
                      style="width: 100%"
                      @keyup.enter="focusNext"
                    >
                  ...
                  <a-col :xs="24" :sm="24" :md="5" :lg="5">
                    <a-form-item :label="$t('stock.Cost')" name="cost"> </a-form-item>
                  </a-col>
                  <a-col :xs="24" :sm="24" :md="7" :lg="7">
                    <a-input-group compact>
                      <a-button type="primary" class="productnumber"> INR </a-button>
                ...
                <a-row :gutter="16">
                  ...
                  <a-col :xs="24" :sm="24" :md="5" :lg="5">
                    <a-form-item
                      ...
                      value=""
                      :help="rules.Free_Scheme ? rules.Free_Scheme.message : null"
                      :validateStatus="rules.Free_Scheme ? 'error' : null"
                    >
                    </a-form-item>
                  </a-col>
