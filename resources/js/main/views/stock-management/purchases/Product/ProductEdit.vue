                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('M_R_P ')" name="mrp" :help="rules.M_R_P
                                                ? rules.M_R_P.message
                                                : null
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="5" :lg="5">
                                        <a-form-item :label="$t('stock.Purchase_Rate')" name="purchase_rate" :help="rules.purchase_rate
                                                ? rules.purchase_rate
                                                    .message
                                                : null
                                ...
                                <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="7" :lg="7">
                                        <TaxCategorySearchInput
                                                ...
                                                @valueSuccess="getStockValue"
                                                :productData="data"
                                                v-model:value="formDataLedger.tax_category" @keyup.enter="focusNext"
                                            />
                                    </a-col>
                                            ...
                                            <span style="display: flex">
                                                <ProductSearchInput @valueChanged="(productId) =>
                                                    (formData.product_id =
                                                        productId)
                                                    " @valueSuccess="getStockValue
                                                        " :productData="data" @keyup.enter="focusNext" />
                                            </span>
                                        </a-form-item>
                                    </a-col>
                                </a-row>
