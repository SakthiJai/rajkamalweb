<template>
                        ...
                        <fieldset class="fieldheightsss">
                          ...
                          <a-row :gutter="24">
                                  ...
                                  <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                      <TaxCategorySearchInput
                                        ...
                                        @valueSuccess="getStockValue"
                                        :productData="data"
                                        v-model:value="formDataLedger.tax_category"
                                        @keyup.enter="focusNext"
                                      />
                                    </a-col>
                                  </a-row>
                                  ...
                                  <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                      <a-input
                                        ...
                                        value=""
                                        @keyup.enter="focusNext"
                                        @input="clearValidationError('opening_stock')"
                                      >
                                      </a-input>
                                    </a-col>
                                  </a-row>
                              ...
                              <a-row :gutter="16">
                                ...
                                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                  <a-input
                                    ...
                                    @input="clearValidationError('low_stock')"
                                    value=""
                                    @keyup.enter="focusNext"
                                  >
                                  </a-input>
                            ...
                            <a-col :xs="24" :sm="24" :md="10" :lg="10">
                              <a-row :gutter="24">
                                ...
                                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                  <a-input-group compact style="display: flex">
                                    <a-span type="primary" class="productnumber inputing"> INR </a-span>
              
                                    <a-input
                                      autocomplete="off"
                                      v-model:value="formDataLedger.M_R_P"
                                      style="width: 79%"
                                      type="text"
                                      maxlength="10"
                                      :placeholder="'0.00'"
                              ...
                              <a-row :gutter="24">
                                <a-col :xs="24" :sm="24" :md="9" :lg="9">
                                  <a-form-item
                                    ...
                                    name="purchase_rate"
                                    :validateStatus="rules.purchase_rate ? 'error' : ''"
                              ...
                              <a-row :gutter="24">
                                <a-col :xs="24" :sm="24" :md="9" :lg="9">
                                  <a-form-item
                                    ...
                                    name="sale_rate"
                                    :validate-status="rules.sale_rate ? 'error' : ''"
                              ...
                              <a-row :gutter="24">
                                <a-col :xs="24" :sm="24" :md="9" :lg="9">
                                  <a-form-item :label="$t('stock.category')" name="name"> </a-form-item>
                                </a-col>
                                <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                  <CategorySearchInput
                                    @valueChanged="
                                  ...
                                  <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                      <a-input
                                        ...
                                        v-model:value="formDataLedger.item_disc"
                                        value=""
                                        @keyup.enter="focusNext"
                                        @focus="focusinputvalue($event)"
                                      >
                                  ...
                                  <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                      <a-input
                                        autocomplete="off"
                                        name="volume_dis"
                                        v-model:value="formDataLedger.volume_dis"
                                        value=""
                                        @keyup.enter="focusNext"
                                        @focus="focusinputvalue($event)"
                                      >
                                  ...
                                  <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                      <a-input
                                        autocomplete="off"
                                        name="max_disc"
                                        v-model:value="formDataLedger.max_disc"
                                        value=""
                                        @keyup.enter="focusNext"
                                        @focus="focusinputvalue($event)"
                                      >
                                  ...
                                  <a-row :gutter="16">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="14" :lg="14">
                                      <a-input
                                        autocomplete="off"
                                        name="min_margin_others"
                                        v-model:value="formDataLedger.min_margin_others"
                                        value=""
    ...
    <!-- Popup Modal    import fields from "../../../stock-management/purchases/ProductItem/fields";        -->
...
export default defineComponent({
  ...
  methods: {
    ...
    validatePurchaseRate() {
      ...
      if (purchaseRate >= mrp) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `Purchase Rate should be less than or equal to MRP.`,
        });
        return false;
      }
    ...
    validateCostRate() {
      ...
      if (cost >= mrp) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `Cost should be less than or equal to M.R.P.`,
        });
        return false;
        ...
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `Cost should be less than or equal to PR.`,
        });
        return false;
      } else if (cost >= saleRate) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `Cost should be less than or equal to Rate A(Sale Rate).`,
        });
        return false;
      } else if (cost >= rateB) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `Cost should be less than or equal to Rate B.`,
        });
        return false;
      } else if (cost >= rateD) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `Cost should be less than or equal to Rate D.`,
        });
        return false;
      } else if (cost > rateF) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `Cost should be less than or equal to Rate F.`,
        });
        return false;
      }
    ...
    validateSaleRate() {
      ...
      if (saleRate >= mrp) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateA should be less than or equal to M.R.P.`,
        });
        return false;
      } else if (saleRate <= cost) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateA should be greater than or equal to cost.`,
        });
        return false;
      }
    ...
    validateRateB() {
      ...
      if (rateB >= mrp) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateB should be less than or equal to M.R.P.`,
        });
        return false;
        ...
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateB should be greater than or equal to PR.`,
        });
        return false;
      }
    ...
    validateRateD() {
      ...
      if (rateD >= mrp) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateD should be less than or equal to M.R.P.`,
        });
        return false;
        ...
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateD should be greater than or equal to PR.`,
        });
        return false;
      }
    ...
    validateRateF() {
      ...
      if (rateF >= mrp) {
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateF should be less than or equal to M.R.P.`,
        });
        return false;
        ...
        notification.error({
          placement: "bottomRight",
          message: "Validation Error",
          description: `RateF should be greater than or equal to PR.`,
        });
        return false;
      }
    ...
    //     // Define refs for the first input of each tab
    ...
    Modal.confirm({
        ...
        icon: createVNode(ExclamationCircleOutlined),
        content: "Transaction data will be lost, Are you sure you want to close?",
        onOk: () => { // Using an arrow function here to preserve `this` context
            this.$router.push({
    ...
    focusNext(e) {
      ...
      if (currentIndex < formElements.length - 1) {
        if (
          ...
          this.formDataLedger.hsn_sac.trim() != ""
        ) {
          formElements[currentIndex + 1].focus();
        } else if (
    ...
    validateInput() {
      ...
      if (!this.formDataLedger.name || this.formDataLedger.name.trim() === "") {
        this.rules.name = {
      ...
      if (!this.formDataLedger.god_owns || this.formDataLedger.god_owns.trim() === "") {
        this.rules.god_owns = {
          message: "God Owns is required.",
        };
        isValid = false;
      } else {
        this.rules.god_owns = null;
      }

      if (
        !this.formDataLedger.opening_stock ||
        this.formDataLedger.opening_stock.trim() === ""
      ) {
        this.rules.opening_stock = {
          message: "Opening Stock is required.",
        };
        isValid = false;
      } else {
        this.rules.opening_stock = null;
      }

      if (!this.formDataLedger.low_stock || this.formDataLedger.low_stock.trim() === "") {
        this.rules.low_stock = {
          message: "Low Stock is required.",
        };
        isValid = false;
      } else {
        this.rules.low_stock = null;
      }

      if (
        !this.formDataLedger.unit_1st ||
        (typeof this.formDataLedger.unit_1st === "string" &&
          this.formDataLedger.unit_1st.trim() === "")
      ) {
        isValid = false;
      } else {
        this.rules.unit_1st = null;
      }

      if (
        !this.formDataLedger.hsn_sac ||
        (typeof this.formDataLedger.hsn_sac === "string" &&
          this.formDataLedger.hsn_sac.trim() === "")
      ) {
        isValid = false;
      } else {
        this.rules.hsn_sac = null;
      }

      if (
        !this.formDataLedger.tax_category ||
        (typeof this.formDataLedger.tax_category === "string" &&
          this.formDataLedger.tax_category.trim() === "")
      ) {
        // this.rules.tax_category = {
        //   message: "tax_category is required.",
        // };
        isValid = false;
      } else {
        this.rules.tax_category = null;
      }
    ...
    getCustomerData(id) {
            try {
                axiosAdmin.get(`product-list/${id}`).then((response) => {
                    console.log("<>", response);
  ...
  mounted() {
    const customerId = this.$route.params.id; // Access "id" parameter
    if (customerId) {
      this.getCustomerData(customerId);
    } else {
      console.error('Customer ID not found in route params.');
    }
    document
