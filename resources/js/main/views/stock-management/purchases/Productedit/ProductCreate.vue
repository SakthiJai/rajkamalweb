...
// import BarcodeGenerator from "E:\wamp64\www\rajkamals\rajkamal\resources\js\common\components\barcode\BarcodeGenerator.vue";
...
export default defineComponent({
  ...
  try {
    ...
    const productCode = this.formDataLedger.product_code || '000000';
    const timestamp = Date.now();
    this.formDataLedger.barcode_value = `${productCode}${timestamp}`;

    if (this.validateInput()) {
      console.log("Submitting:", this.formDataLedger);
