    ...
    methods: {
      ...
      this.$nextTick(() => {
        ...
        printpdf()
        {
            ...
            console.log("PDF click Sales Return",document.getElementById('form_item_bill_number').value);
            this.loading= true;
            axiosAdmin
            .post("sales-return/getPurchaseReturnPdf", {invoice:document.getElementById('form_item_bill_number').value})
            .then(response => {
                this.$emit('closed');
