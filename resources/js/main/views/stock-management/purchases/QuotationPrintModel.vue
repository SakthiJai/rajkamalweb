...
export default defineComponent({
    ...
    methods: {
        ...
        printpdf() {
            ...
            this.loading = true;
            axiosAdmin
                .post("quotation/getQuotationPdf", {
                    invoice:
                        "QT-" +
                        document.getElementById("form_item_quotation_number")
                            .value,
                })
                .then((response) => {
                    this.$emit("closed");
        ...
        previewpdf() {
            console.log("PDF preview click");
            this.loading = true;
            axiosAdmin
                .post("quotation/getQuotationPdf", {
                    invoice: document.getElementById(
                        "form_item_quotation_number"
                    ).value,
                })
                .then((response) => {
                    let w = window.open(response, "_blank");
        ...
        WhatsAppOutlined() {
            notification.warning({
                ...
                message:
                    "We are on the way to bring the Whatsapp Integration !",
                description: "",
            });
        },
        closePrint() {
        ...
        //         content:
        //             "vicky data will be lost. Are you sure you want to close?",
        //         onOk() {
        //             that.$emit("closed");
        //         },
        //         onCancel() {
        //             console.log("vicky close canceled");
        //         },
        //     });
        // },
    },
