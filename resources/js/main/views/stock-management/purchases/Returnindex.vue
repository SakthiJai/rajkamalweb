        ...
        <template #header>
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="3" :lg="3">
                    <h3 class="gstinvoice"> Return Bill List</h3>
                </a-col>
                ...
                <a-col :xs="24" :sm="24" :md="7" :lg="7" style="text-align:right;">
                    ...
                    ">
                            <a-button type="primary" class="creating" @click="createNewPurchaseEntry()">
                                <PlusOutlined />
                                Create F2
                            </a-button>
                    </template>
...
import PurchaseReturnOrderTable from "../../../components/order/PurchaseReturnOrderTable.vue";
export default {
    components: {
        PlusOutlined,
        DeleteOutlined,
    ...
    mounted() {
    document.getElementById("Returnindex").addEventListener('keydown', this.handleKeydown);
    this.autoFocusInput();

  },
  beforeDestroy() {
    document.getElementById("Returnindex").removeEventListener('keydown', this.handleKeydown);
  },
    methods:
    {
    ...
    //   });
      ...
      rowselect(value){ console.log("rowtestingg",value)
        ...
        mouseselect(value)
        {
             console.log("mouse select working", value)
            localStorage.setItem("selectedInvoice", value);
                    this.$router.push({
                    name: `admin.stock.purchase-return.create`
                });
        ...
        test(event)
        {
            console.log(123232, this.selectedRowInvoice ,event.keyCode);
            console.log(this.filters.searchString, 'key code', event.keyCode, this.PurchaseReturnOrderTableRef);
    ...
    setup() {
        ...
        const PurchaseReturnOrderTableRef = ref(null);
