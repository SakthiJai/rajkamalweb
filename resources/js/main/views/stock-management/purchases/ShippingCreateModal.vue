  ...
  >
    ...
    <template v-slot:title>
      <div style="display: flex; justify-content: space-between; align-items: center">
        <span>Create Shipping Details</span>
        <button
    ...
    <form ref="myForm1" id="myForm1" layout="vertical" @submit.prevent="">
        ...
        <a-col :xs="24" :sm="24" :md="24" :lg="24">
          <fieldset class="">
            ...
            <!-- <a-row :gutter="16" style="margin-bottom: 16px">
              <a-col :span="6">
                <a-form-item label="Address Type">
                  <a-select
                    v-model:value="formDataLedger.is_temporary"
                    @change="handleAddressTypeChange"
                  >
                    <a-select-option :value="0">Shipping Address</a-select-option>
                    <a-select-option :value="1">Temporary Address</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row> -->

            <!--   :label="formDataLedger.is_temporary ? $t('Temporary Address') : $t('Shipping Address')" -->
            <a-row :gutter="16">
      ...
      <!-- Checkbox placed after Shipping Contact No -->
     <a-row :gutter="16" style="margin-bottom: 16px">
          <a-col :span="24">
            <a-form-item>
              <a-checkbox
                v-model:checked="formDataLedger.is_temporary"
                :true-value="1"
                :false-value="0"
              >
                Temporary Address
...
export default defineComponent({
        ...
        success: (res) => {
          notification.success({
            placement: "bottomRight",
             message: formDataLedger.is_temporary
              ? "Temporary Address saved successfully"
  ...
  methods: {
    // Modified reset form
    resetForm() {
        console.log('resetForm called from:', new Error().stack);
