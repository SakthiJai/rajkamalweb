<template>
        ...
        <template #header>
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="3" :lg="3">
                    <h3 class="gstinvoice">Customer List</h3>
                </a-col>
                ...
                <a-col :xs="24" :sm="24" :md="7" :lg="7">
                    ...
                    ">
                            <a-button type="primary" class="creating" @click="createNewBillEntry()">
                                <PlusOutlined />
                                Create F2
                            </a-button>
                    </template> -->
    ...
    <admin-page-table-content>
            ...
            <CustomerOrdertable ref="BillReturnOrderTableRef" :orderType="orderType" :filters="filters" tableSize="middle" :bordered="true"
...
import OrderTable from "../../../../../main/components/order/OrderTable.vue";
import CustomerOrdertable from "../../../../../main/components/order/CustomerOrdertable.vue";
  ...
  beforeDestroy() {
    ...
    methods:
    {
      ...
      /*this.$router.push({
        ...
        test(event)
        {
            console.log('key code',event.keyCode,this.BillReturnOrderTableRef);
