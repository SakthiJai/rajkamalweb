<template>
        ...
        <template #header>
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="3" :lg="3">
                    <h3 class="gstinvoice"> Quotation List</h3>
                </a-col>
    ...
    <admin-page-table-content>
        <OrderTable ref="orderTableRef" salesType="salestype=quotations" :orderType="orderType" :filters="filters" tableSize="middle" :bordered="true"
...
export default {
    ...
    mounted() {
        document.getElementById("quotationindex").addEventListener('keydown', this.handleKeydown);
    this.autoFocusInput();

  },
  beforeDestroy() {
    document.getElementById("quotationindex").removeEventListener('keydown', this.handleKeydown);
        ...
        showconfirm()
        {
            ...
            //autoFocusButton:'cancel',
                onOk() {
                    ...
                    document.getElementById("quotationindex").removeEventListener('keydown', that.handleKeydown);
