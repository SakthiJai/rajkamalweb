<template>
        <div id="returnlistindex">

    <AdminPageHeader>
        <template #header>

            <a-row :gutter="16">
                <a-col :xs="24" :sm="27" :md="20" :lg="20">
                    <h3 class="gstinvoice"> Sales Return Credit Note List  </h3>
                </a-col>


                <a-col :xs="24" :sm="24" :md="4" :lg="4" style="text-align:right;">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="24" :xl="24">
                <a-row :gutter="[16, 16]">
                    ...
                    <a-col :xs="24" :sm="24" :md="8" :lg="11" :xl="11" style="text-align:right">
                        ...
                        :title="`${$t('Sales Return / Cr.Note List')}`"
                    />
...
import SalesReturnOrderTable from "../../../components/order/SalesReturnOrderTable.vue";
...
export default {
    ...
    mounted() {
     document
    .getElementById("returnlistindex").addEventListener('keydown', this.handleKeydown);
    this.autoFocusInput();
  ...
  beforeDestroy() {
    ...
    methods:
    {
        selectDateRange(range) {
           // this.selectedRange = range.trim();
            ...
            this.SalesReturnOrderTableRef.setUrlData(this.selectedRange);
        ...
        createNewSalesEntry()
        {
           console.log(this.orderPageObject.type);
            window.localStorage.removeItem("cr_number");
             window.localStorage.removeItem("selectedInvoice");
             console.log(localStorage.getItem("cr_number"));
      ...
      else if(event.keyCode ==27)
      {
        ...
        test(event)
        {
            console.log('key code',event.keyCode,this.SalesReturnOrderTableRef);
            this.SalesReturnOrderTableRef.test(event);
    ...
    setup() {
        ...
        const SalesReturnOrderTableRef = ref(null);

        const filters = ref({
            payment_status: "all",
            user_id: undefined,
            dates: [],
            searchColumn: "cr_number",
            searchString: "",
        });
